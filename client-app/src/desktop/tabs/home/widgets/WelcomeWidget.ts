                ...
                div({
                    ...
                    items: [
                        ...
                        p(
                            ...
                            "'s full-stack toolkit for data-dense enterprise web apps: a curated React + MobX front end - grids, charts, dashboards, forms - on a Grails / Spring Boot server framework. Refined over a decade of continuous development on demanding real-world apps."
                        ),
                        p(
