...
export const mobileTab = hoistCmp.factory(() =>
    wrapper({
        description: [
            p('Mobile apps share many of the same components and logic as their desktop counterparts, with some mobile-specific Hoist components that are supported by the open-source framework ', a({href: 'https://onsen.io', target: '_blank', item: 'Onsen'}), ' to improve the native mobile UI experience. Explore the Toolbox Mobile App on your device at ', a({href: 'https://toolbox.xh.io/mobile', target: '_blank', item: 'toolbox.xh.io/mobile'}), '.')
        ],
        item: panel({
            className: 'tb-mobile',
            bbar: [
