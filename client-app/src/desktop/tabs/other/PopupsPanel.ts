import {div, hbox, li, p, span, ul, vbox} from '@xh/hoist/cmp/layout';
...
import {demoRow, demoSection, wrapper} from '../../common';
                ...
                items: [
                    demoSection({
                        ...
                        items: [
                            ...
                            apiRow(
                                'Prompt',
                                'Collects a value. Resolves to it, or null on cancel.',
                                button({
                            ...
                            apiRow(
                                ...
                                button({
                                    ...
                                    onClick: () =>
                                        XH.toast({
                                            message:
                                                'This is a Toast. Bottom right of app by default.'
                                        })
                                }),
                                button({
                                    ...popBtn(Icon.toast({intent: 'warning'})),
