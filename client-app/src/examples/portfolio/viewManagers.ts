...
/**
 * ViewManagerModels for the Portfolio app.
 *
 ...
 */
class ViewManagers {
    /** Saved layouts for the main Portfolio view. */
    portfolioLayout: ViewManagerModel;

    async initAsync(ctx: InitContext) {
        this.portfolioLayout = await ViewManagerModel.createAsync(
            {
