...
export const scrollablePanelPage = hoistCmp.factory({
    ...
    render({model}) {
        const items = [
            p('This Panel is set to be scrollable, causing its inner contents to scroll when overflowed.')
        ];
