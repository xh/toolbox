...
test('Hoist Inputs Test', async ({page, tb}) => {
    ...
    await tb.getByTestId('hoist-inputs-textInput2').locator('button').click();
    ...
    await tb.fillJson('hoist-inputs-jsonInput-input', '{"isFilled": true}');
    ...
    await tb.fill('hoist-inputs-dateInput1-input-date-text', '2023-08-30');
